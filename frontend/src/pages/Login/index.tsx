              ...
              <form onSubmit={handleSubmit} className="mt-6">
                ...
                <div className="mt-5 text-center xl:mt-8 xl:text-left">
                  <Button
                    ...
                    className="bg-gradient-to-r from-theme-1/70 to-theme-2/70 w-full py-3.5 xl:mr-3 dark:border-darkmode-400 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
