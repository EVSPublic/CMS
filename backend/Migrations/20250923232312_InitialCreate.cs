        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogoPath = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ThemeConfig = table.Column<string>(type: "json", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Announcements_AspNetUsers_UpdatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContentPages_AspNetUsers_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ContentPages_AspNetUsers_UpdatedBy",
                        column: x => x.UpdatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ContentPages_Brands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MediaFiles_AspNetUsers_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_MediaFiles_Brands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Partnerships_AspNetUsers_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Partnerships_AspNetUsers_UpdatedBy",
                        column: x => x.UpdatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Partnerships_Brands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StaticPages_AspNetUsers_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_StaticPages_AspNetUsers_UpdatedBy",
                        column: x => x.UpdatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_StaticPages_Brands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Brands",
                columns: new[] { "Id", "CreatedAt", "Domain", "LogoPath", "Name", "ThemeConfig", "UpdatedAt" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 9, 23, 23, 23, 10, 602, DateTimeKind.Utc).AddTicks(7147), "ovolt.com", null, "Ovolt", null, new DateTime(2025, 9, 23, 23, 23, 10, 602, DateTimeKind.Utc).AddTicks(7161) },
                    { 2, new DateTime(2025, 9, 23, 23, 23, 10, 602, DateTimeKind.Utc).AddTicks(9480), "sharz.net", null, "Sharz.net", null, new DateTime(2025, 9, 23, 23, 23, 10, 602, DateTimeKind.Utc).AddTicks(9494) }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentPages_BrandId_PageType",
                table: "ContentPages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentPages_UpdatedBy",
                table: "ContentPages",
                column: "UpdatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_MediaFiles_BrandId",
                table: "MediaFiles",
                column: "BrandId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Partnerships_BrandId",
                table: "Partnerships",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_Partnerships_CreatedBy",
                table: "Partnerships",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_Partnerships_UpdatedBy",
                table: "Partnerships",
                column: "UpdatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_StaticPages_BrandId_Slug",
                table: "StaticPages",
